...
@Component({
  selector: 'app-info-student1',
  templateUrl: './info-student1.page.html',
  styleUrls: ['./info-student1.page.scss'],
})
export class InfoStudent1Page implements OnInit {
  ...
  ngOnInit() {
    this.studentService.read_student_nws7().subscribe(data => {
