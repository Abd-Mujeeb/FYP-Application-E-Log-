...
@Component({
  selector: 'app-info-student2',
  templateUrl: './info-student2.page.html',
  styleUrls: ['./info-student2.page.scss'],
})
export class InfoStudent2Page implements OnInit {
  ...
  ngOnInit() {
    this.studentService.read_student_wbd().subscribe(data => {
