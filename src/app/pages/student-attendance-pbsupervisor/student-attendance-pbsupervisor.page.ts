...
@Component({
  ...
  templateUrl: './student-attendance-pbsupervisor.page.html',
  styleUrls: ['./student-attendance-pbsupervisor.page.scss'],
})
export class StudentAttendancePbsupervisorPage implements OnInit {
